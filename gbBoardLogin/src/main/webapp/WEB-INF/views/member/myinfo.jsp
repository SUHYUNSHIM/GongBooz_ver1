    ...
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="${pageContext.request.contextPath}/resources/image/swiper_1.png" />
        </div>
        <div class="swiper-slide">
          <img src="${pageContext.request.contextPath}/resources/image/swiper_2.png" />
        </div>
        <div class="swiper-slide">
          <img src="${pageContext.request.contextPath}/resources/image/swiper_3.png" />
        </div>
        <div class="swiper-slide">
          <img src="${pageContext.request.contextPath}/resources/image/swiper_4.png" />
        </div>
        <div class="swiper-slide">
          <img src="${pageContext.request.contextPath}/resources/image/swiper_1.png" />
        </div>
      ...
      <div class="swiper-pagination"></div>
		...
		<section>
			...
			<a href="memberUpdateView.do" style="color:#ffffff;">회원정보수정 </a>/
			<a href="memberDeleteView.do" style="color:#ffffff;">회원탈퇴</a>
			</div>
				</div>
			</div>
