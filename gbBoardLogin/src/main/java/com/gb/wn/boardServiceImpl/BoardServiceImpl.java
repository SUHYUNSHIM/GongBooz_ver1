package com.gb.wn.boardServiceImpl;
...
import com.gb.wn.boardDAO.BoardDAO;
...
public class BoardServiceImpl implements BoardService {
	...
	public int ltlikecount(LikeVO likevo) throws Exception {
		return bdao.ltlikecount(likevo);
	}

	@Override
	public int ltlikegetinfo(LikeVO likevo) throws Exception {
		return bdao.ltlikegetinfo(likevo);
	}
...
//	@Override
//	public void likeupdate(LikeVO likevo) throws Exception {
//		
//		bdao.likeupdate(likevo);
//	}
	@Override
